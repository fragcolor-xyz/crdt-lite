...
using SimpleBlockCRDT = BlockCRDT<uint32_t>;              // Simple material IDs
using NFTBlockCRDT = BlockCRDT<uint64_t>;                 // NFT references
using RichBlockCRDT = BlockCRDT<std::pair<uint64_t, uint32_t>>; // NFT ID + metadata
